  ...
  const handleEmailSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Successfully signed up. Please check your email to verify your account if necessary, or you are already logged in.",
      });
      navigate("/");
    } catch (error: any) {
      toast({
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50/50 p-4">
      <div className="w-full max-w-[420px] bg-white rounded-xl shadow-lg border border-gray-100 p-8">
        ...
        <div className="flex flex-col items-center mb-8 text-center">
          ...
          <p className="text-sm text-gray-500 mt-1">Join CIH today</p>
        </div>
